...
<link rel="stylesheet" href="/tn/theme/theme_wide_16/css/default.css?ver=<?php echo time(); ?>">
<!--[if lte IE 8]>
...
<!-- Bootstrap core CSS -->
<link href="/bootstrap/bootstrap4.5.css?ver=<?php echo time(); ?>" rel="stylesheet">
<!-- fontawesome -->
...
<body<?php echo isset($g5['body_script']) ? $g5['body_script'] : ''; ?>  <?php

if(defined('_INDEX_')) { ?>id="hantitntnMain" <?php } ?> >
<?php
